<?php
  ...
  $type = $_GET["type"];
  $record_list = record()->list("userId=$account->Id and type='$type' order by name");

  if ($role=="Admin") {
    $record_list = record()->list("type='$type' order by name");
  }
      ...
      <div class="card bg-light-info shadow-none position-relative overflow-hidden">
        <div class="card-body px-4 py-3">
          <div class="row align-items-center">
            <div class="col-9">
              <h4 class="fw-semibold mb-8"><?=$type?></h4>
            </div>
            <div class="col-3">
...
<?php if ($role=="Faculty"): ?>
            ...
            <a href="javascript:void(0)" id="btn-add-contact" class="btn btn-info mt-3 mb-3">
              <i class="ti ti-users text-white me-1 fs-5"></i> Upload <?=$type?>
            </a>
        ...
        <div class="modal fade" id="addContactModal" tabindex="-1" role="dialog" aria-labelledby="addContactModalTitle" aria-hidden="true">
          <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
              ...
              <form action="process.php?action=record-save"  enctype="multipart/form-data" id="addContactModalTitle" method="post">
              <div class="modal-body">
                <div class="row">
                  <div class="col-12">
                    ...
                    <input type="hidden" name="userId" class="form-control" value="<?=$account->Id;?>" required>
                  </div>
                ...
                <tr class="search-items">
                  ...
                  <td>
                    <div class="action-btn">
                      <a href="../media/<?=$row->image?>" class="btn btn-primary" target="_blank">View File</a>
                      <?php if ($role=="Faculty"): ?>
                        <a href="process.php?action=record-delete&Id=<?=$row->Id?>&type=<?=$type?>" class="btn btn-danger">Delete</a>
                      <?php endif; ?>
                    </div>
                  </td>
                </tr>
