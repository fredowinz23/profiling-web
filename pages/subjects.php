...
?>
      ...
      <div class="widget-content searchable-container list">
          ...
          <a href="javascript:void(0)" id="btn-add-contact" class="btn btn-info mt-3 mb-3">
            <i class="ti ti-users text-white me-1 fs-5"></i> Add Subject
          </a>
        ...
        <div class="modal fade" id="addContactModal" tabindex="-1" role="dialog" aria-labelledby="addContactModalTitle" aria-hidden="true">
          <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
              ...
              <form action="process.php?action=subject-save" id="addContactModalTitle" method="post">
                ...
                <div class="row">
                  ...
                  <div class="col-12">
                    ...
                    <select class="form-control" name="strandId" required>
                      ...
                      <?php foreach ($strand_list as $row): ?>
            ...
            <table class="table search-table align-middle text-nowrap">
              ...
              <tbody>
                ...
                foreach ($subject_list as $row):
                  $strand = strand()->get("Id=$row->strandId");
                  $count += 1;
                   ?>
                ...
                <tr class="search-items">
                  ...
                  <td>
                    <div class="action-btn">
                      ...
                      <a href="process.php?action=subject-delete&Id=<?=$row->Id?>&url=<?=$current_url?>" class="text-dark ms-2">
